    ...
    <el-card style="padding-bottom:100px;">
        <el-table v-loading="loading" :data="pluginList">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
                <template slot-scope="scope">
                    <el-button size="small" type="success" style="padding:5px;" icon="el-icon-edit" @click="loadMqttPlugin(scope.row.name)"  v-if="!scope.row.active">启动</el-button>
                    <el-button size="small" type="danger" style="padding:5px;" icon="el-icon-delete" @click="unloadMqttPlugin(scope.row.name)"  v-else>停止</el-button>
                </template>
            </el-table-column>
        </el-table>
