...
public class DeviceController extends BaseController
{
     ...
     */
    @PreAuthorize("@ss.hasPermi('iot:device:query')")
    @GetMapping(value = "/thingsModelValue/{deviceId}")
    @ApiOperation("获取设备物模型值")
    public AjaxResult getDeviceThingsModelValue(@PathVariable("deviceId") Long deviceId)
    {
        return AjaxResult.success("操作成功",deviceService.selectDeviceThingsModelValueById(deviceId));
    }
    ...
    @PutMapping("/thingsModelValue")
    @ApiOperation("更新设备物模型值")
    public AjaxResult updateDeviceThingsModelValue(@RequestBody IdAndName idAndName)
    {
        return toAjax(deviceService.updateDeviceThingsModelValue(idAndName));
    }
